            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-6">
                    <div class="about_part_img">
                        <img src="theme/img/Edu-Brousher.png" alt="">
                    </div>
                </div>
    ...
    <section class="about_part experiance_part section_padding">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="about_part_img">
                        <img src="theme/img/principal.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            {{--<div class="filters-content">--}}
                {{--<div class="row justify-content-between portfolio-grid">--}}
                    {{--<div class="col-lg-4 col-sm-6 all buildings">--}}
                        {{--<div class="single_our_project">--}}
                            {{--<div class="single_offer">--}}
                                {{--<img src="theme/img/project_1.png" alt="offer_img_1">--}}
                    ...
                    {{--<div class="col-lg-4 col-sm-6 all rebuild">--}}
                        {{--<div class="single_our_project">--}}
                            {{--<div class="single_offer">--}}
                                {{--<img src="theme/img/project_2.png" alt="offer_img_1">--}}
                                {{--<div class="hover_text">--}}
                                    {{--<p>Bank Protected</p>--}}
                                    {{--<a href="#"><h2>Banking & Finance</h2></a>--}}
                                {{--</div>--}}
                    ...
                    {{--<div class="col-lg-4 col-sm-6 all architecture">--}}
                        {{--<div class="single_our_project">--}}
                            {{--<div class="single_offer">--}}
                                {{--<img src="theme/img/project_3.png" alt="offer_img_1">--}}
                                {{--<div class="hover_text">--}}
                                    {{--<p>Bank Protected</p>--}}
                                    {{--<a href="#"><h2>Banking & Finance</h2></a>--}}
                                {{--</div>--}}
            ...
            {{--<div class="row">--}}
                {{--<div class="col-lg-3 col-sm-6">--}}
                    {{--<div class="single_counter_icon">--}}
                        {{--<img src="theme/img/icon/Icon_1.svg" alt="">--}}
                    {{--</div>--}}
                ...
                {{--<div class="col-lg-3 col-sm-6">--}}
                    {{--<div class="single_counter_icon">--}}
                        {{--<img src="theme/img/icon/Icon_2.svg" alt="">--}}
                    {{--</div>--}}
                    {{--<div class="single_member_counter">--}}
                ...
                {{--<div class="col-lg-3 col-sm-6">--}}
                    {{--<div class="single_counter_icon">--}}
                        {{--<img src="theme/img/icon/Icon_3.svg" alt="">--}}
                    {{--</div>--}}
                    {{--<div class="single_member_counter">--}}
                ...
                {{--<div class="col-lg-3 col-sm-6">--}}
                    {{--<div class="single_counter_icon">--}}
                        {{--<img src="theme/img/icon/Icon_4.svg" alt="">--}}
                    {{--</div>--}}
                    {{--<div class="single_member_counter">--}}
                ...
                {{--<div class="col-lg-6 col-sm-12">--}}
                    {{--<div class="review_part_cotent owl-carousel">--}}
                        {{--<div class="single_review_part">--}}
                            {{--<img src="theme/img/client/client_2.png" alt="">--}}
